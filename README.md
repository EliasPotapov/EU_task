...
<br>
task_EU.ipynb - это файл Jupiter Notebook: код на Python с примечаниями в Markdown-ячейках. Здесь описан и проиллюстрирован весь анализ, построены графики и написаны краткие выводы/наблюдения.
